...
```javascript
import add5 from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-ops-add5@v0.1.0-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/math-base-ops-add5/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/math-base-ops-add5/actions/workflows/test.yml?query=branch:v0.1.0
